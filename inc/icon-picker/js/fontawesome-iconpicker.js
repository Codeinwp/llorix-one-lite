...
(function(a) {
	...
	c.prototype = {
		...
		_bindElementEvents: function() {
			var c = this;
			this.getSearchInput().on(
				"keyup.iconpicker", function() {
				c.filter( a( this ).val().toLowerCase() );
			}
				);
			this.getAcceptButton().on(
				"click.iconpicker", function() {
		...
		_bindWindowEvents: function() {
			...
			a( window ).on(
				"resize.iconpicker" + d + " orientationchange.iconpicker" + d, function(a) {
		...
		filter: function(c) {
			if (b.isEmpty( c )) {
				...
				var d = [];
				this.iconpicker.find( ".iconpicker-item" ).each(
					function() {
					var b = a( this );
