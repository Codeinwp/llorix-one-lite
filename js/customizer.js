...
( function( $ ) {
	...
	**************************************/
	...
	wp.customize(
		'llorix_one_lite_very_top_header_phone', function(value) {
		value.bind(
			function( to ) {
	...
	wp.customize(
		 'llorix_one_lite_very_top_header_show', function( value ) {
		value.bind(
			 function( to ) {
					 if ( true !== to ) {
	...
	*************************************/
	...
	wp.customize(
		 'llorix_one_lite_logos_show', function( value ) {
		value.bind(
			 function( to ) {
					 if ( true !== to ) {
	...
	**************************************/
	...
	wp.customize(
		'llorix_one_lite_blog_header_title', function(value) {
		value.bind(
			function( to ) {
	...
	wp.customize(
		'llorix_one_lite_blog_header_subtitle', function(value) {
		value.bind(
			function( to ) {
	...
	wp.customize(
		'llorix_one_lite_blog_header_image', function(value) {
		value.bind(
			function( to ) {
	...
	****************************************/
	...
	wp.customize(
		'llorix_one_lite_logo', function(value) {
		value.bind(
			function( to ) {
			if ( to !== '' ) {
	...
	wp.customize(
		'llorix_one_lite_header_logo', function( value ){
		value.bind(
			function( to ) {
	...
	wp.customize(
		'llorix_one_lite_header_title', function(value) {
		value.bind(
			function( to ) {
			var llorix_one_lite_header = $( '#llorix_one_lite_header' );
			if ( to !== '' ) {
	...
	wp.customize(
		'llorix_one_lite_header_subtitle', function(value) {
		value.bind(
			function( to ) {
			var llorix_one_lite_header = $( '#llorix_one_lite_header' );
			if ( to !== '' ) {
	...
	wp.customize(
		'llorix_one_lite_header_button_text', function(value) {
		value.bind(
			function( to ) {
			var llorix_one_lite_header = $( '#llorix_one_lite_header' );
			if ( to !== '' ) {
	...
	wp.customize(
		'llorix_one_lite_header_button_link', function(value) {
		value.bind(
			function( to ) {
			var llorix_one_lite_header = $( '#llorix_one_lite_header' );
			if (to.charAt( 0 ) === '#') {
	...
	*******************************************************/
	...
	wp.customize(
		 'llorix_one_lite_our_story_show', function( value ) {
		value.bind(
			 function( to ) {
					 if ( true !== to ) {
	...
	*******************************************************/
	...
	wp.customize(
		 'llorix_one_lite_ribbon_show', function( value ) {
		value.bind(
			 function( to ) {
					 if ( true !== to ) {
	...
	wp.customize(
		 'llorix_one_lite_ribbon_background', function( value ) {
		value.bind(
			 function( to ) {
					 if ( '' !== to ) {
	...
	wp.customize(
		'llorix_one_lite_button_link', function(value) {
		value.bind(
			function( to ) {
	...
	*******************************************************/
	...
	wp.customize(
		 'llorix_one_lite_latest_news_show', function( value ) {
		value.bind(
			 function( to ) {
					 if ( true !== to ) {
	...
	***************************************/
	...
	wp.customize(
		 'llorix_one_lite_contact_info_show', function( value ) {
		value.bind(
			 function( to ) {
					 if ( true !== to ) {
	...
	****************************************/
	...
	wp.customize(
		'llorix_one_lite_copyright', function(value) {
		value.bind(
			function( to ) {
