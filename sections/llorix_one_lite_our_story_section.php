...
<?php
	global $wp_customize;
	$llorix_one_our_story_image = get_theme_mod('llorix_one_our_story_image', llorix_one_lite_get_file('/images/about-us.png'));
	$llorix_one_our_story_title = get_theme_mod('llorix_one_our_story_title',esc_html__('Our Story','llorix-one-lite'));
						...
						<?php
							if( !empty($llorix_one_our_story_image) ){
								if( !empty($llorix_one_our_story_title) ){
									...
									echo '<div class="col-md-6 brief-content-two"><div class="brief-image-right"><img src="'.esc_url($llorix_one_our_story_image).'" alt="'.esc_html__('About','llorix-one-lite').'"></div></div>';
								}
...
?>
			<section class="brief text-left brief-design-one brief-left llorix_one_lite_only_customizer" id="story" role="region" aria-label="<?php esc_html_e('About','llorix-one-lite') ?>">
				<div class="col-md-6 brief-content-two llorix_one_lite_only_customizer"><img src="" alt=""><div class="brief-image-right"></div></div>
				<div class="col-md-6 content-section brief-content-one">
					<h2 class="text-left dark-text llorix_one_lite_only_customizer"></h2><div class="colored-line-left llorix_one_lite_only_customizer"></div>
