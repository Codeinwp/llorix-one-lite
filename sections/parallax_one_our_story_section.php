...
?>
			<section class="brief text-left brief-design-one brief-left llorix_one_only_customizer" id="story" role="region" aria-label="<?php esc_html_e('About','llorix-one-lite') ?>">
